...
class TaskListView(CurrentUserMixin, ReportDownloadSearchView):
    model = Task
...
class TaskCreateView(CurrentUserMixin, CCECreateView):
    model = Task
    sidebar_group = ['tasks']
...
class TaskUpdateView(CurrentUserMixin, CCEUpdateView):
    model = Task
...
class TaskStatusUpdateView(CurrentUserMixin, CCEUpdateView):
    model = Task
...
class TaskDeleteView(CurrentUserMixin, CCEDeleteView):
    model = Task
    sidebar_group = ['tasks']
...
class TaskDetailView(CurrentUserMixin, CCEDetailView):
    model = Task
