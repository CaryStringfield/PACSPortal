...
class BoardListView(CurrentUserMixin, CCESearchView):
    model = Board
...
class BoardCreateView(CurrentUserMixin, CCECreateView):
    model = Board
...
class BoardUpdateView(CurrentUserMixin, CCEUpdateView):
    model = Board
...
class BoardDeleteView(CurrentUserMixin, CCEDeleteView):
    model = Board
